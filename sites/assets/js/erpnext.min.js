...
me.frm.set_value("mode_of_payment",values.mode_of_payment);var paid_amount=flt((flt(values.paid_amount)-flt(values.change))/me.frm.doc.conversion_rate,precision("paid_amount"));me.frm.set_value("paid_amount",paid_amount);me.frm.set_value("write_off_amount",me.frm.doc.base_grand_total-paid_amount);me.frm.set_value("outstanding_amount",0);me.frm.savesubmit(this);dialog.hide();me.refresh();})}});erpnext.pos.make_pos_btn=function(frm){frm.page.add_menu_item(__("{0} View",[frm.page.current_view_name==="pos"?"Form":"Point-of-Sale"]),function(){erpnext.pos.toggle(frm);});if(frm.pos_btn)return;if(cint(sys_defaults.fs_pos_view)!==1||frm.doctype==="Material Request"){return;}
